...
public:
     ...
     * @note
     */
    bool scan(const QString &pattern, RespType &value, qulonglong cursor = 0, qulonglong count = 1000);
     ...
     * @note
     */
    bool sscan(const QString& key, const QString &pattern, RespType &value, qulonglong cursor = 0, qulonglong count = 1000);
     ...
     * @note
     */
    bool zscan(const QString& key, const QString &pattern, RespType &value, qulonglong cursor = 0, qulonglong count = 1000);
     ...
     * @note
     */
    bool hscan(const QString& key, const QString &pattern, RespType &value, qulonglong cursor = 0, qulonglong count = 1000);
...
signals:
    ...
    void sigMessage(const QByteArray &msg);
    void sigPMessage(const QByteArray &msg);
    void sigReply(const QByteArray &msg);
};
